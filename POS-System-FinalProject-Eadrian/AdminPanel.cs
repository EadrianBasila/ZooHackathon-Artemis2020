...
namespace POS_System_FinalProject_Eadrian
{
    public partial class AdminPanel : Form
    {
        ...
        private void loadAdmin_Click(object sender, EventArgs e)
        {
            ...
            peepsCategory.Text= adminAdminDV.Rows[0].Cells[4].Value.ToString();
            apdateTimePicker.Value = Convert.ToDateTime(adminAdminDV.Rows[0].Cells[5].Value.ToString());
        }
        ...
        private void loadEmployee_Click(object sender, EventArgs e)
        {
            ...
            peepsCategory.Text = adminEmployeeDV.Rows[0].Cells[4].Value.ToString();
            apdateTimePicker.Value = Convert.ToDateTime(adminEmployeeDV.Rows[0].Cells[5].Value.ToString());
        }
        ...
        private void adminAdminDV_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            peepsCategory.Text = adminAdminDV.Rows[e.RowIndex].Cells[4].Value.ToString();
            apdateTimePicker.Text = adminAdminDV.Rows[e.RowIndex].Cells[5].Value.ToString();       
        }
        ...
        private void adminEmployeeDV_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            peepsCategory.Text = adminEmployeeDV.Rows[e.RowIndex].Cells[4].Value.ToString();
            apdateTimePicker.Text = adminEmployeeDV.Rows[e.RowIndex].Cells[5].Value.ToString();
        }
